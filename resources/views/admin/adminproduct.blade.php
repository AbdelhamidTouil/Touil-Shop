    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
                ...
                <a href="{{ Route('insertproduct') }}">Insert Product</a>
                ...
                <tr align="center">
                   ...
                   <td>{{ $products->name }}</td>
                    ...
                    <td><img width="100px" height="100px" src="assets/products_image/{{ $products->image }}" alt="{{ $products->name }}" ></td>
                    <td><a href="{{ route('editproduct',['id'=>$products->id]) }}"><button class="btn btn-info">Edit</button></a></td>
                    <td><a href="{{ route('deleteproduct',['id'=>$products->id]) }}"><button class="btn btn-danger">Delete</button></a></td>
